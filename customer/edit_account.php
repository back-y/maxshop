...
<form action="" method="post" enctype="multipart/form-data"><!-- form begin -->
    ...
    <div class="form-group"><!-- form-group begin -->
        ...
        <img class="img-responsive" src="image/customer_images/<?php echo $customer_image; ?> " alt="Customer Image">
...
<?php
    ...
    if(isset($_POST['update'])){
        ...
        move_uploaded_file($c_image_tmp,"image/customer_images/$c_image");

        $update_customer = "update customers set customer_name='$c_name',customer_email='$c_email',
        customer_country='$c_country',customer_city='$c_city',customer_address='$c_address',
